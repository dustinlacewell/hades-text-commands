import { Attachment, AwaitReactionsOptions, Collection, CollectorFilter, EmbedBuilder, EmojiIdentifierResolvable, Message, MessageEditOptions, MessageReaction, MessageReplyOptions, ReactionCollectorOptions, User } from "discord.js";
